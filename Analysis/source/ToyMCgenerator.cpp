...
//  constructed with the <DecayParticle> class, which allows to define them given its  //
//  mass, width and/or resolution, or a TF1/PDF. All the particles and links between   //
//  them (daughters, granddaughters...) have to be specified before the Monte-Carlo    //
//  generation. It is performed via the <ToyMCgenerator> class, which uses the         //
//  information of a mother particle or the distributions of a given TTree.            //
//                                                                                     //
// ----------------------------------------------------------------------------------- //
/////////////////////////////////////////////////////////////////////////////////////////
