...
General::Vector::Vector( double x, double y, double z ) :
  fX( x ), fY( y ), fZ( z ) { }
...
General::Vector General::Vector::GetLong( General::Vector vec ) {
...
General::Vector General::Vector::GetTran( General::Vector vec ) {
...
void General::Vector::RotateX( double angle ) {
...
void General::Vector::RotateY( double angle ) {
...
void General::Vector::RotateZ( double angle ) {
...
General::Vector General::Vector::Unitary() {
